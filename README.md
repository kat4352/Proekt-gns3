# Proekt-gns3
Изначальная цель данного проекта: сделать отказоустойчивую корпаративную сеть используя технологию VLAN для разделения пользователей, маршрутизацией с использованием router-on-a-stick и резирвированием шлюзов по протоколу HSRP.
